...
class ComputaProvider(Provider):
    ...
    def __init__(self, keeper, ipfs_client, account):
        ...
        super(ComputaProvider, self).__init__(keeper,ipfs_client,account)

    def check_service_agreements(self, computa_ddo, algorithm_ddo, consumer_address):
